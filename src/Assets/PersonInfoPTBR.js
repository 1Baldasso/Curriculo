  ...
  person: {
    ...
    experiences: [
      ...
      },
      {
        ...
        listWay: [
          "Coordenar atividades nas equipes de desenvolvimento backend e frontend, incluindo atribuição de tarefas, revisão de código e garantia de qualidade do código.",
          "Projetar arquitetura de software escalável e selecionar microservices apropriados para implantação.",
          "Projetar e implementar APIs RESTful usando C# e .NET Core.",
          "Gerenciar o ambiente Azure, incluindo a criação de recursos, implantação de aplicações e monitoramento de serviços.",
          "Trabalhar com Azure Cognitive Services, SignalR, WebSockets e WebHooks.",
          "Usar o Linear como ferramenta de gerenciamento de projetos e o GitHub como sistema de controle de versão.",
        ],
      },
      {
        name: "PayeWaive",
        ...
        description: `Na PayeWaive, meu papel envolveu o desenvolvimento de testes automatizados, preparação do ambiente para o Desenvolvimento Orientado a Testes (TDD) e refatoração de código existente. Também contribuí para a melhoria da arquitetura da solução e o desenvolvimento de novos recursos. Desenvolvi funcionalidades ligadas a pagamentos, como a integração com API externas. Também desenvolvi funcionalidades de manipulação de documentos, como preenchimento de documentos Word e PDF, e a criação e preenchimento de documentos a partir de templates.`,
        listWay: [
      ...
      },
      {
        ...
        description: `Trabalhei criando queries utilizando Linq para acessar o banco de dados e gerar relatórios, realizar cálculos e validar as regras de negócio. Durante este processo, fui responsável por garantir que todas as informações relevantes fossem incluídas nos relatórios, que os cálculos fossem precisos e que as regras de negócio estivessem sendo seguidas corretamente. Além disso, criei casos de teste para rodar testes de unidade no código antes de ser entregue. Trabalhei em conjunto com a equipe de testes para realizar testes de integração e identificar possíveis inconsistências e levantar hipóteses de soluções. Ao longo do projeto, mantive uma comunicação clara e constante com o time para garantir que todas as informações fossem compartilhadas e que as atividades estivessem devidamente alinhadas.`,
        listWay: [
          "Desenvolvi consultas usando Linq para acessar o banco de dados e gerar relatórios, realizar cálculos e validar regras de negócios.",
          "Criei casos de teste para executar testes unitários no código antes da entrega.",
          "Trabalhei em estreita colaboração com a equipe de teste para realizar testes de integração e identificar possíveis inconsistências, bem como hipóteses para soluções.",
          "Mantive comunicação clara e constante com a equipe para garantir que todas as informações fossem compartilhadas e que as atividades estivessem devidamente alinhadas.",
          "Permaneci atento a possíveis melhorias nos processos e sugeri ideias para otimizar o trabalho em equipe.",
        ],
      },
      {
    ...
    skills: [
      ...
      {
        name: "VSIX e Ferramentas de Extensão",
        proficiency: 7,
        image: "",
      },
      {
